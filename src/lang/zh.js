export default {
  ...
  data: {
    ...
    myevent: {
      numOpenIssue:"Open Issue",
      numCloseIssue:"Closed Issue",
      numRelease:"Release Number",
      numDeveloper:"Developer Number",
      mostActive:"Most active developer",
      ...
      accountData: "仓库数据",
      noRepoSize: "仓库",
      myevent: "Typical Issue Resolution Time (unit:h)",
      noMyevent: "最近操作",
      table: {
        variance:"Variance",
        average:"Average",
range:"Range",
    ...
    dheader: "Information of Repository",
    dleft: {
      accountStars: "Hot Topics",
      accountLeng: "仓库语言分类",
      noStarData: "一个Stars",
      nolanguageData: "一种语言"
    },
